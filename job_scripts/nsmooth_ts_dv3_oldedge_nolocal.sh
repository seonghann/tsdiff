...
CUDA_VISIBLE_DEVICES=3 python3 train_ts.py configs/exp7/nosmooth_ts_dv3_oldedge_nolocal.yml --fn _ --project TS-geom-exp7 --name nosmooth_dv3_oldedge_nolocal
